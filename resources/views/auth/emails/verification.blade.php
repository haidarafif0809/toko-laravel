                                                                        ...
                                                                        <tr>
                                                                              <td class="wrapper">
                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                          <tr>
                                                                                                <td>
                                                                                                       <h1 style="color:#737373;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:24px;font-style:normal;font-weight:600;letter-spacing:normal;margin:0;padding:0;text-align:center">KavePos</h1><br><br><br>
                                                                                                      <h4><p>Hi KavePos Lovers,</p></h4>
                                                                                                      <p>Terima kasih telah mendaftar di KavePos. </p>
                                                                                                                                    ...
                                                                                                                                    <tbody>
                                                                                                                                          <tr>
                                                                                                                                                <td> <div class="container">
                                                                                                                                                      ...
                                                                                                                                                      <center><p>Klik tombol di bawah ini untuk aktivasi akun KavePos Anda :</p></center>
                                                                                                                                                      <hr>
                                                                                                                                                      <center>
                                                                                                                                                            <p>
