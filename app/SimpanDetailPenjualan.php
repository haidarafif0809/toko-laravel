...
{
    protected $fillable = [
        'no_faktur', 'id_satuan', 'id_produk', 'id_modifier', 'id_kategori', 'id_penjualan', 'harga_produk', 'jumlah_produk', 'diskon', 'diskon_persen', 'subtotal',
    ];
    ...
    public function scopeDataSimpanDetailPenjualan($query, $id_penjualan)
    {
        $query->select([
            ...
            'simpan_detail_penjualans.id_kategori',
